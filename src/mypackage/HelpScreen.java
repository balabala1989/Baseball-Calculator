...
public class HelpScreen extends MainScreen implements FieldChangeListener {
	...
	public HelpScreen() {
        ...
        rtfHeading = new RichTextField("About Baseball Calculator", RichTextField.TEXT_ALIGN_HCENTER){
       ...
       stHelpContents = new StringBuffer();
		stHelpContents.append("\t A simple app that helps you to calculate following Technical Parameters in Baseball. \n");
		stHelpContents.append("1.  Base Running Average\n2.  Batting Average\n3.  Earned Run Average\n4.  Fielding Percentage\n5.  Slugging Percentage\n\n");
		stHelpContents.append("Usage :-\n1.  Provide necessary input\n2.  \"Calculate\" will calculate and give you the necessary paramter\n");
        ...
        fontHeading = getFontToDisplay("Comic Sans MS", 20);
